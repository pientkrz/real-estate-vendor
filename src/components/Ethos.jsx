      ...
      <div className="max-w-screen-2xl mx-auto px-12 grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="text-on-surface-variant text-lg leading-relaxed mb-8">
            Local P Home isn't just a brokerage; we are curators of environments. We understand that a luxury residence is an asset of both capital and soul. Our team specializes in off-market acquisitions and bespoke architectural consultancy.
          </p>
