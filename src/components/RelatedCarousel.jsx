...
const RelatedCarousel = ({ posts, currentPostId }) => {
  ...
  return (
    <section className="py-24 bg-bone border-t border-primary/10">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex justify-between items-end mb-12">
          <div>
            <span className="text-primary font-label text-xs tracking-[0.4em] uppercase mb-4 block">Archive</span>
            <h2 className="text-3xl md:text-5xl font-headline font-bold tracking-tight">Further <span className="italic font-light">Reading</span></h2>
          </div>
            ...
            >
              <div className="relative aspect-square overflow-hidden mb-6 bg-obsidian/5">
                ...
                <div className="absolute top-6 right-6 bg-bone/90 backdrop-blur-sm px-4 py-2">
                  <span className="text-[10px] font-label tracking-widest text-obsidian uppercase">
