...
6. **P1 — Niespójny język interfejsu**
   - Problem: polski interfejs zawiera angielskie elementy, między innymi „Editorial Narrative”, „Geographical Context”, „Sale”, „Read Full Inquiry” oraz angielski nagłówek bloga.
   - Rekomendacja: ujednolicić teksty interfejsu do języka polskiego; język obcojęzyczny pozostawiać tylko w treści dostarczonej przez dostawcę oferty.
